...
import net.m1sha365.lichdom.client.model.entity.MutantZombieModel;
...
public class MutantZombieRenderer extends DynamicGeoEntityRenderer<DynamicExampleEntity> {
	...
	protected final ResourceLocation CAPE_TEXTURE = ResourceLocation.fromNamespaceAndPath(LichdomCommon.MODID, "textures/entity/dynamic_entity_cape.png");
