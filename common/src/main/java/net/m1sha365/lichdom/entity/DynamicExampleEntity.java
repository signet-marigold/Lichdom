package net.m1sha365.lichdom.entity;
 ...
 * @see net.m1sha365.lichdom.client.renderer.entity.MutantZombieRenderer MutantZombieRenderer
...
public class DynamicExampleEntity extends PathfinderMob implements GeoEntity {
	...
	protected InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		if (player instanceof ServerPlayer serverPlayer)
			serverPlayer.sendSystemMessage(Component.translatable("entity." + LichdomCommon.MODID + ".mutant_zombie.equip", stack.getDisplayName()));
