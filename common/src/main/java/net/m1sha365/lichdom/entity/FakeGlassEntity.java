 ...
 *
 * @see net.m1sha365.lichdom.client.model.entity.FakeGlassModel FakeGlassModel
 * @see net.m1sha365.lichdom.client.renderer.entity.FakeGlassRenderer FakeGlassRenderer
 */
