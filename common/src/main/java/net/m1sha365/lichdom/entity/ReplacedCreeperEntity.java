 ...
 * @see net.m1sha365.lichdom.client.renderer.entity.ReplacedCreeperRenderer ReplacedCreeperRenderer
 * @see net.m1sha365.lichdom.client.model.entity.ReplacedCreeperModel ReplacedCreeperModel
 */
